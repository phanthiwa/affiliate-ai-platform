                    ...
                    return (
                      <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 bg-slate-900/60 p-4 rounded-xl border border-slate-800/80">
                          ...
                          <div className="sm:col-span-5 relative rounded-2xl overflow-hidden bg-slate-950 aspect-[9/16] max-h-[380px] mx-auto border-2 border-purple-500/50 shadow-2xl flex flex-col justify-between p-3 select-none">
                            {/* Background Image / Motion Simulator */}
                            ...
                            <div className="relative z-10 flex items-center justify-between text-[11px] text-white">
                              <span className="px-2 py-0.5 rounded-full bg-black/60 backdrop-blur-md text-[10px] flex items-center gap-1">
                                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-ping"></span> LIVE PROMPT
                              </span>
                            ...
                            <div className="relative z-10 space-y-2 text-left">
                              ...
                              <div className="flex items-center gap-1.5 text-[10px] text-slate-300">
                                ...
                                <span className="line-clamp-1">เสียงพากย์: {activeClip.script.style_persona}</span>
                              </div>
                            </div>
                          </div>
